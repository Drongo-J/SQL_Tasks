...
--
--
-- Creating Views for Queries from previous task
--
--
...
GO
CREATE VIEW ClassroomNamesAndBuildings
AS
SELECT DISTINCT
	LR.[Name],
	LR.Building
...
GO
CREATE VIEW TeacherFullnamesOfFaculty
AS
SELECT
	T.[Name]
FROM 
...
GO
CREATE VIEW DaysOfWeekA102AndA103Classes
AS
SELECT DISTINCT
